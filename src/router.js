  ...
  routes: [
    {
      ...
      children: [
        ...
        },
        {
          ...
          index: 7,
          component: () =>
            import("./views/components/vuesax/checkbox/checkbox.vue")
        },
        {
          path: "/collapse",
          name: "Collapse",
        ...
        },
        {
          ...
          index: 18,
          component: () =>
            import("./views/components/vuesax/number-input/number-input.vue")
        },
        {
          path: "/pagination",
          name: "Pagination",
        ...
        },
        {
          ...
          index: 29,
          component: () =>
            import("./views/components/vuesax/textarea/textarea.vue")
        },
        {
          path: "/login",
          name: "login",
